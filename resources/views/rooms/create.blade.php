...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
    <div>
        <h2 class="h3 mb-1 fw-bold text-primary">Create New Room</h2>
        <p class="text-muted mb-0">Tambahkan ruangan baru untuk jadwal perkuliahan</p>
    </div>
    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm rounded-4 mb-5">
            <div class="card-header bg-transparent border-0 pt-4 pb-2 px-4">
                <h5 class="fw-bold mb-0 text-primary"><i class="fas fa-door-open me-2"></i> Room Information</h5>
            </div>
